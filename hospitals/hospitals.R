...
# Investigate the hospitals that are in the
# "not a hospital, health/feacility/service provider, or
# health infrastructure/ service provider" category
d_0_hosp <- bmf[ which( bmf$h == 0 & bmf$hosp == 1 ), ]
write.csv( d_0_hosp, "d_0_hosp.csv" )

# Recode the problematic NTEEs
bmf$NTEEFINAL[ bmf$EIN %in% c( 42794625, 203700131, 232201344, 250965292, 
                               251925187, 260335902, 261720984, 261947374, 
                               263734606, 264230898, 273733278, 275401105,
                               311518658, 331065485, 340714756, 380350304, 
                               381676780, 383833117, 450227753, 463851119, 
                               473793197, 474196634, 476028103, 480958974, 
                               481226976, 481226977, 593051173, 640655993, 
                               741287016, 742759890, 811708177, 812240617, 
                               814653630, 822567308, 822748395, 824372339, 
                               841276376 )] <- "E20"
bmf$NTEEFINAL[ bmf$EIN %in% c( 452964467, 455023260, 581509251, 630931008,
                               821406555 )] <- "E21"
bmf$NTEEFINAL[ bmf$EIN %in% c( 760536234, 411801967 )] <- "E32"
bmf$NTEEFINAL[ bmf$EIN %in% c( 370808925, 520607921 )] <- "E91"
bmf$NTEEFINAL[ bmf$EIN %in% c( 880401489 )] <- "F22"
bmf$NTEEFINAL[ bmf$EIN %in% c( 990298651 )] <- "F30"

# Add an "other hospitals" category to the hospital taxonomy
bmf$h <- rep( 17, nrow(bmf) )
bmf$h[ !( bmf$hosp == 1 & bmf$NTEEFINAL %in% c( "E20", "E22",
                                "E21", "E32", "E30", "E31", "E80",
                                "E24", "E61", "E65", "E6A",
                                "E60", "E50", "E99", "P50", "E86",
                                "F40", "E62", "P52", "P60", "P61", "P58", "P85", 
...
bmf$h[ bmf$NTEEFINAL %in% c( "G20", "G25", "G30", "G32", "G40", "G41", "G42", 
                             ...
                             "G60", "G61", "G70", "G80", "G81", "G83", "G84", 
                             "G99" )] <- 15
bmf$h[ bmf$hosp == 1 & !( bmf$NTEEFINAL %in% c( "E20", "E22", "B43",
                                "E21", "E32", "E30", "E31", "E80",
                                "E24", "E61", "E65", "E6A",
                                "E60", "E50", "E99", "P50", "E86",
                                "F40", "E62", "P52", "P60", "P61", "P58", "P85", 
