...
Now that most EINs have a group_num, we can group by GEN to find the most likely parent name for each GEN.
...
Repeat step 1, but now adding the GEN_name from `GEN_name_crosswalk`. 
...
```{r}
write_csv(ein.gen.crosswalk.final, file = "affiliate/data-rodeo/EIN-GEN-crosswalk.csv" )

GEN_ParentName_crosswalk <- GEN_name_crosswalk
EIN_GEN_crosswalk <- ein.gen.crosswalk.final

save(GEN_ParentName_crosswalk, EIN_GEN_crosswalk, file = "affiliate/data-rodeo/GEN-ParentName-EIN-crosswalk.Rda")
