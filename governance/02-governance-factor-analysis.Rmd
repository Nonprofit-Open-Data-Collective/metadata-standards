...
I decided the remove P6_Line_7 entirely since its removal makes the factors analysis incredibly clean. I will talk to Jesse about the implications of this. Is stakeholders something we want to measure in our governance index?
...
features2_ID <- design_mat_ID 

## Save design matrix
save(features2, features2_ID,
     file = "governance/governance-design-matrix.Rdata")
