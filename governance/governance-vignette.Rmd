...
## How to make a governance index
...
|                      |                      |     method           |
+----------------------+----------------------+----------------------+
| Line 1               | P12_L I N E          | If P12_LINE_1 is     |
|                      | \_1_OTHER_EXPLAIN    | "other", then this   |
|                      |                      | is what is written   |
|                      |                      | for other            |
+----------------------+----------------------+----------------------+
| Line 2a              | P12_LINE_2A          | -   "no" - answer to |
|                      |                      |     question 2a is   |
|                      |                      |     no               |
|                      |                      |                      |
|                      |                      | -   "separate" -     |
...
|                      |                      |     is checked       |
+----------------------+----------------------+----------------------+
| Line 2b              | P12_LINE_2B          | -   "no" - answer to |
|                      |                      |     question 2a is   |
| Notes: Something is  |                      |     no               |
| wrong about this     |                      |                      |
| coding. There are    |                      | -   "separate" -     |
| many F 9 \_ 1 2      |                      |     answer to        |
| \_FINSTAT_AUDIT_X == |                      |     question 2b is   |
| FALSE, But F9_12_FIN |                      |     yes and the box  |
| S T A T              |                      |     for "separate    |
| \_AUDIT_CONSOL_X,    |                      |     basis" is        |
| F9_12\_ F I N S      |                      |     checked          |
| TAT_AUDIT_SEP_X, or  |                      |                      |
| F9_12\_ F I N S      |                      | -   "colsol" -       |
| TAT_AUDIT_BOTH_X is  |                      |     answer to        |
| checked              |                      |     question 2b is   |
|                      |                      |     yes and the box  |
|                      |                      |     for              |
|                      |                      |                      |
|                      |                      | "consolidated basis" |
...
|                      |                      |     is checked       |
+----------------------+----------------------+----------------------+
| Line 2C              | P12_LINE_2C          | -   "no" - answer to |
|                      |                      |     question 2c is   |
|                      |                      |     no               |
|                      |                      |                      |
|                      |                      | -   "yes" - answer   |
...
|                      |                      |     is no            |
+----------------------+----------------------+----------------------+
| Line 3A              | P12_LINE_3A          | -   "no" - answer to |
|                      |                      |     question 3a is   |
|                      |                      |     no               |
|                      |                      |                      |
|                      |                      | -   "yes" - answer   |
...
|                      |                      |     is no            |
+----------------------+----------------------+----------------------+
| Line 3B              | P12_LINE_3B          | -   "no" - answer to |
|                      |                      |     question 3b is   |
|                      |                      |     no               |
|                      |                      |                      |
|                      |                      | -   "yes" - answer   |
...
| Line    | Variable   | Levels                                     |
+=========+============+============================================+
| Line 31 | PM_LINE_31 | -   "yes" - the answer to this line is yes |
|         |            |                                            |
...
+======================+======================+======================+
| P4_LINE_12A          | yes/no               | 1 - yes to either    |
|                      |                      | 12A or 12B           |
| P4_LINE_12B          | yes/no               |                      |
|                      |                      | 0 - no to both       |
+----------------------+----------------------+----------------------+
...
|                      |                      |                      |
|                      | yes/no               | 1 - yes to any of    |
|                      |                      | 28A, 28B, or 28C     |
|                      | yes/no               |                      |
+----------------------+----------------------+----------------------+
| P4_Line_29           | yes/no               | 1 - (29 no) or (30   |
|                      |                      | no) or (29 yes and   |
| P4_Line_30           | yes/no               | PM 31 yes) or (30    |
|                      |                      | yes and PM 31 yes)   |
...
|                      |                      | and PM 31 no)        |
+----------------------+----------------------+----------------------+
| P6_LINE_1A,          | numeric              | is P6_LINE_1B /      |
| P6_LINE_1B           |                      | P6_LINE_1A \>= 0.5   |
|                      |                      | \|                   |
|                      |                      |                      |
|                      |                      | i.e. is the          |
|                      |                      | proportion of        |
...
+----------------------+----------------------+----------------------+
| P6_LINE_4            | yes/no               | removed, neither yes |
|                      |                      | or no is not good    |
|                      |                      | nor bad              |
+----------------------+----------------------+----------------------+
| P6_Line_5            | yes/no               | 0/1 (no is good)     |
+----------------------+----------------------+----------------------+
| P6_Line_6            | yes/no               | removed. neither is  |
|                      |                      | good or bad. only    |
|                      |                      | answers to           |
|                      |                      | P6_Line_7A/B matter  |
+----------------------+----------------------+----------------------+
...
+----------------------+----------------------+----------------------+
| P6_LINE_10A          | yes/no               | 1 - (10A no) or (10A |
|                      |                      | yes + 10B yes)       |
| P6_LINE_10B          | yes/no/NA            |                      |
|                      |                      | 0 - (10A yes + 10B   |
|                      |                      | no)                  |
+----------------------+----------------------+----------------------+
| P6_LINE_12B          | yes/no/NA            | 1 - (12A yes + 12B   |
|                      |                      | yes) or (12A no)     |
|                      |                      |                      |
|                      |                      | 0 - (12 A yes + 12B  |
|                      |                      | no)                  |
+----------------------+----------------------+----------------------+
| P6_LINE_12C          | yes/no/NA            | 1 - (12A yes + 12C   |
|                      |                      | yes) or (12A no)     |
|                      |                      |                      |
|                      |                      | 0 - (12 A yes + 12C  |
|                      |                      | no)                  |
+----------------------+----------------------+----------------------+
| P6_LINE_16A          | yes/no               | 1 - (16A no) or (16A |
|                      |                      | yes + 16B yes)       |
| P6_LINE_16B          | yes/no/NA            |                      |
|                      |                      | 0 - (16A yes + 16B   |
|                      |                      | no)                  |
+----------------------+----------------------+----------------------+
| P6_LINE_18           | request/own we       | 1 - own website      |
|                      | bsite/another's      |                      |
...
|                      |                      | 0 - anything else    |
+----------------------+----------------------+----------------------+
| P12_LINE_2A          | both/c on            | 0 - no               |
|                      | sol/no/seperate      |                      |
|                      |                      | 1 - anything else    |
+----------------------+----------------------+----------------------+
| P12_LINE_2B          | both/c on            | 0 - no               |
|                      | sol/no/seperate      |                      |
|                      |                      | 1 - anything else    |
+----------------------+----------------------+----------------------+
| P12_LINE_2C          | yes/no/NA            | 1 -( 2B yes + 2C yes |
|                      |                      | ) or (2A yes + 2C    |
|                      |                      | yes) or (2a no ) or  |
|                      |                      | (2b no)              |
|                      |                      |                      |
...
+----------------------+-------------------------------+---+
| Vari able Name       | Variable Meaning/Coding       |   |
+======================+===============================+===+
| P4\_ LINE \_12A      | Did the org obtain separate,  |   |
|                      | independent audited financial |   |
|                      | statements? 1 - yes, 0 - no   |   |
+----------------------+-------------------------------+---+
| P4 \_LIN E_28        | 1- Answered "no" to questions |   |
|                      | P4_LINE_28A, P4_LINE_28B,     |   |
|                      | **AND** P4_LINE_28            |   |
|                      |                               |   |
|                      | 0 - Answered yes to any of    |   |
|                      | these questions               |   |
|                      |                               |   |
|                      | Essentially 1 if no business  |   |
|                      | was done with a family member |   |
|                      | and 0 otherwise.              |   |
+----------------------+-------------------------------+---+
| P 4_LI NE_2 9_30     | 1- (Answered no to P4_LINE_29 |   |
|                      | ANDP4_Line_29) or (Answered   |   |
|                      | yes to (P4_LINE_29            |   |
|                      | ORP4_Line_29) AND answered    |   |
|                      | yes to Schedule M question 31 |   |
|                      | )                             |   |
|                      |                               |   |
|                      | 0 - Answered yes to           |   |
|                      | (P4_LINE_29 ORP4_Line_29) AND |   |
|                      | answered no to Schedule M     |   |
|                      | question 31                   |   |
|                      |                               |   |
|                      | i.e. 1 if either (the org did |   |
|                      | not have more than \$25K in   |   |
|                      | cash contribution AND did not |   |
|                      | have receive any              |   |
|                      | art/historical                |   |
|                      | treasures/etc.) OR (they do   |   |
|                      | have those things AND they do |   |
|                      | have a written policy about   |   |
|                      | how to handle them)           |   |
+----------------------+-------------------------------+---+
| P 6_LI NE_1          | 1 - The proportion of         |   |
|                      | independent members on the    |   |
|                      | board is at least 50%         |   |
|                      |                               |   |
|                      | 0 - The proportion of         |   |
|                      | independent members on the    |   |
|                      | board is less than 50%        |   |
+----------------------+-------------------------------+---+
| P 6_LI NE_2          | 1- **No** officer, director,  |   |
|                      | trustee, or key employee had  |   |
|                      | a family relationship or a    |   |
|                      | business relationship with    |   |
|                      | any other officer, director,  |   |
|                      | trustee, or key employee      |   |
|                      |                               |   |
|                      | 0- **An** officer, director,  |   |
|                      | trustee, or key employee had  |   |
|                      | a family relationship or a    |   |
|                      | business relationship with    |   |
|                      | any other officer, director,  |   |
|                      | trustee, or key employee      |   |
+----------------------+-------------------------------+---+
| P 6_LI NE_3          | 1- The org **did not** use a  |   |
...
|                      | management duties             |   |
+----------------------+-------------------------------+---+
| P6 \_LIN E_8A        | 1 - The meetings by the       |   |
|                      | governing body **are**        |   |
|                      | documented                    |   |
|                      |                               |   |
|                      | 0 - The meetings by the       |   |
|                      | governing body **are**        |   |
|                      | **not** documented            |   |
+----------------------+-------------------------------+---+
| P6_L INE\_ 12_1 3_14 | 1- The answers to P6_Line_12, |   |
|                      | 13, and 14 are all yes        |   |
|                      |                               |   |
|                      | 0- otherwise                  |   |
|                      |                               |   |
|                      | i.e. 1 if the organization    |   |
|                      | has a written conflict of     |   |
|                      | interest policy, **AND** a    |   |
|                      | written whistleblower policy, |   |
|                      | **AND** a written retention   |   |
|                      | and destruction policy.       |   |
|                      |                               |   |
|                      | These 3 are combined because  |   |
|                      | seperated they have \>0.90    |   |
|                      | correlation. And all of these |   |
|                      | questions get at the same     |   |
|                      | type of governance - do you   |   |
|                      | have written policies for     |   |
|                      | when things go bad?           |   |
+----------------------+-------------------------------+---+
| P6\_ LINE \_11A      | 1- A copy of Form 990 is      |   |
|                      | provided to all members       |   |
|                      | before filing the form        |   |
|                      |                               |   |
|                      | 0 - otherwise                 |   |
+----------------------+-------------------------------+---+
| P6\_ LINE \_15A      | 1- The org has a process for  |   |
|                      | determining compensation of   |   |
|                      | the CEO, executive director,  |   |
|                      | or top management officials   |   |
|                      | including a review and        |   |
|                      | approval by independent       |   |
|                      | persons, comparability data,  |   |
|                      | and deliberation decision     |   |
|                      |                               |   |
|                      | 0 - otherwise                 |   |
+----------------------+-------------------------------+---+
| P6 \_LIN E_18        | 1 - Forms 1023 (or 1024),     |   |
|                      | 990, 990-T available for      |   |
|                      | public inspection on own      |   |
|                      | website                       |   |
|                      |                               |   |
|                      | 0 - These forms were listed   |   |
|                      | on another's website,         |   |
|                      | available upon request, or    |   |
|                      | "other"                       |   |
+----------------------+-------------------------------+---+
| P1 2_LI NE_1         | Did the org use accrual       |   |
|                      | method for accounting? 1 -    |   |
|                      | yes, 0- no                    |   |
+----------------------+-------------------------------+---+
...
+----------------------------------+----------------------------------+
| Variables( positive meaning i.e. | Factor Group Names               |
| value = 1)                       |                                  |
+----------------------------------+----------------------------------+
| -   P12_Line_1: Accounting       | -   Have doc                     |
|     method is accural (bad is    |                                  |
|     anything else)               | umentable/                       |
|                                  |                                  |
| -   P4_Line_12: The organization | written                          |
|     obtains separate,            |                                  |
|     independent audited          | accounting                       |
|     financial statements         |                                  |
|                                  | practices and                    |
| -   P6_Line_12_13_14: The        |                                  |
|     organization has a written   | general                          |
|     conflict of interest policy, |                                  |
|     a written whistleblower      | policies                         |
|     policy, and a written        |                                  |
|     retention and destruction    |                                  |
|     policy                       |                                  |
+----------------------------------+----------------------------------+
| -   P6_LINE_8A: The meetings by  | -   Open d                       |
|     the governing body are       |                                  |
|     documented                   | ocumenting of orga               |
|                                  |                                  |
|     -   Correlated with 8b.      | nizational                       |
|         meetings by each         |                                  |
|         committee are documented | business                         |
+----------------------------------+----------------------------------+
| -   P6_LINE_15A: The org has a   | -   Good                         |
|     process for determining      |                                  |
|     compensation of the CEO,     | policies for making the board    |
|     executive director, or top   | and for paying them              |
...
|     and deliberation decision    |                                  |
|                                  |                                  |
|     -   Correlated with Line     |                                  |
|         15b. The org has a       |                                  |
|         process for determining  |                                  |
|         compensation of other    |                                  |
|         officers or key          |                                  |
|         employees includin a     |                                  |
...
|     voting board is \>50%        |                                  |
+----------------------------------+----------------------------------+
| -   (Negative) P6_LINE_3: The    | -   The or ?did? using a         |
|     org did not use a management |                                  |
|     company or other person to   | management                       |
|     perform any management       |                                  |
|     duties                       | company                          |
+----------------------------------+----------------------------------+
| -   P6_Line_11A: A copy of Form  | -   IRS forms are                |
|     990 is provided to all       |                                  |
|     members before filing the    | available for public             |
|     form                         |                                  |
|                                  | inspection                       |
| -   P6_Line_18: Forms 1023 (or   |                                  |
|     1024), 990, 990-T available  |                                  |
|     for public inspection on own |                                  |
|     website                      |                                  |
+----------------------------------+----------------------------------+
| -   (Negative) P4_Line_28: The   | -   These are all about doing    |
|     org was **not** a party to a |                                  |
|     business transaction to with | business with family or having   |
|     an entity of which a current | large/                           |
|     or former officer, director, |                                  |
|     trustee, or key employee was | expensive                        |
|     an officer, director,        |                                  |
|     trustee, or direct or        | assests                          |
|     indirect owner               |                                  |
|                                  |                                  |
| -   (Negative) P6_Line_2: **No** |                                  |
|     officer, director, trustee,  |                                  |
|     or key employee had a family |                                  |
...
|                                  |                                  |
| -   (Negative) P4_Line_29:       |                                  |
|     Either (the org did not have |                                  |
|     more than \$25K in cash      |                                  |
|     contribution AND did not     |                                  |
|     have receive any             |                                  |
|     art/historical               |                                  |
|     treasures/etc.) OR (they do  |                                  |
|     have those things AND they   |                                  |
